...
async function configure() {
  let downloadUrl = process.env.DLSTATION_URL;
  let account = process.env.DLSTATION_ACCOUNT;
  let password = process.env.DLSTATION_PASSWORD;
  ...
  const dlAPI = 'SYNO.DLSTATION.Task';
